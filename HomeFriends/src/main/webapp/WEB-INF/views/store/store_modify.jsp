...
<head>
	...
	<script>
		...
		$(document).ready(function(){
			...
			$('select[name="free_delivery"]').find('option[value="${vo.free_delivery}"]').attr("selected",true);
			if(${vo.free_delivery eq 'N'}){
				$('#deliveryChargeArea').css("display","inline-block")
			}
			$('select[name="category"]').find('option[value="${vo.category}"]').attr("selected",true);
			switch (${vo.category}) {
				case 10:
					$('#detailArea1').css("display","inline-block");
					break;
				case 20:
					$('#detailArea2').css("display","inline-block");
					break;
				case 30:
					$('#detailArea3').css("display","inline-block");
					break;
				case 40:
					$('#detailArea4').css("display","inline-block");
					break;
				case 50:
					$('#detailArea5').css("display","inline-block");
					break;
				case 60:
					$('#detailArea6').css("display","inline-block");
					break;
				default:
	...
	<section>
		...
		<form id="insertFrm" name="insertFrm" method="post">
			...
			<div id="productNameArea" class="area">
				<input type="text" id="productName" name="product_name" class="placeholderInput" placeholder="상품명을 입력해주세요." value="${vo.product_name}">
			...
			<div id="originPriceArea" class="area">
				<input type="text" id="originPrice" name="origin_price" class="placeholderInput" placeholder="할인 전 가격을 입력해주세요." value="${vo.origin_price}">
			...
			<div id="salePriceArea" class="area">
				<input type="text" id="salePrice" name="sale_price" class="placeholderInput" placeholder="할인 후 판매 가격을 입력해주세요." value="${vo.sale_price}">
				<label for="salePrice">
			...
			<div id="discountArea" class="area">
				<input type="text" id="discount" name="discount" class="placeholderInput" placeholder="할인율을 입력해주세요." value="${vo.discount}">
				<label for="discount">
			...
			<div id="brandArea" class="area">
				<input type="text" id="brand" name="brand" class="placeholderInput" placeholder="브랜드를 입력해주세요." value="${vo.brand}">
			</div>
			...
			<div id="deliveryChargeArea" class="area">
				<input type="text" id="deliveryCharge" name="delivery_charge" class="placeholderInput" placeholder="배송비를 입력해주세요." <c:if test="${vo.free_delivery eq 'N'}">value="${vo.delivery_charge}"</c:if>>
