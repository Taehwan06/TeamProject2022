...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
	...
	<script src="${pageContext.request.contextPath}/js/mypage/password_check.js"></script>
			...
			<div class="row">
				<div class="col-12 coll-pull-12 coll-md-12 col-lg-12 col-xl-12 member_modiv">
					...
					<div id="memberEdit_wrap">
						<form name ="CheckPassFrm" class="CheckPassFrm" id="CheckPassFrm" method="post">
							<div class="edit_dummy">
								...
								<div class="text-span">	
									<div class="Edit vacantSpan"></div><span style="color:red; font-weight:700; font-size:0.9rem;">&nbsp;&nbsp;비밀번호가 바르지 않습니다</span>
								</div>
							</div>
							<div class="memberEditSubmit">
								<input type="button" value="비밀번호 변경하러 가기" name="submitBtn" id="submitBtn" onclick="CheckPassFn()">
