		...
		<div class="modal-content">
			...
			<div class="modal-body row">
				...
				<form class="col-12" id="modalSearchFrm" name="modalSearchFrm">
		 			<input type="text" id="modalSearchInput" name="search_value">
		 			<button id="modalSearchButton" name="searchValue" onclick="modalSearchFn()">
...
<header>
	<div class="row" id="headerDiv">
		...
		<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" class="bi bi-list col-1 col-sm-1 headerMenu" data-bs-toggle="modal" data-bs-target="#exampleModal" viewBox="0 0 16 16" id="smallMenu" >
		...
		<button class="iconBtn col-md-1" onclick="location.href='${pageContext.request.contextPath}/recentView.do'">
			<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" class="bi bi-tv headerMenu" viewBox="0 0 16 16" id="viewList">
