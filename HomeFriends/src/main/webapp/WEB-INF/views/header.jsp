	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body row">
				<div class="col-6 modalMenu">
					<input type="button" id="loginBtn" class="modalMenuBtn" onclick="" value="로그인">
				</div>
				<div class="col-6 modalMenu">
					<input type="button" id="joinBtn" class="modalMenuBtn" onclick="" value="회원가입">		
				</div>
				<div class="col-4 modalMenu iconMenu">
					<button class="modalIconBtn">
				...
				<div class="accordion" id="accordionExample">
						...
						<div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
							<div class="accordion-body">
								<ul class="list-unstyled">
									<li class="detailMenu" onclick="">카테고리</li>
									<li class="detailMenu" onclick="">베스트</li>
									<li class="detailMenu" onclick="">핫딜</li>
									<li class="detailMenu" onclick="">추천 상품</li>
									<li class="detailMenu" onclick="">좋아요</li>
								</ul>
							</div>
						</div>
					</div>
					<div class="accordion-item">
						...
						<div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
							<div class="accordion-body">
								<ul class="list-unstyled">
									<li class="detailMenu" onclick="">홈 스토리</li>
									<li class="detailMenu" onclick="">팔로잉</li>
									<li class="detailMenu" onclick="">스크랩</li>
									<li class="detailMenu" onclick="">질문 & 답변</li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="col-8 modalTextMenu eventMenu" onclick="">
					이벤트
				</div>
...
<header>
	<div class="row" id="headerDiv">
		...
		<form class="col-md-6 col-sm-7" id="searchFrm" name="searchFrm">
			...
			<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" class="bi bi-list col-2 col-sm-2 headerMenu" data-bs-toggle="modal" data-bs-target="#exampleModal" viewBox="0 0 16 16" id="smallMenu" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
