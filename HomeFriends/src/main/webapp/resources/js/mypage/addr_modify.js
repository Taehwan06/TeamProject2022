...
function checkSubmitFn(){
	var result = true;
	var post_code = document.getElementById('sample6_postcode').value;
	var addr =  document.getElementById("sample6_address").value;
    var detail_addr = document.getElementById("sample6_detailAddress").value;
    
    
    if(post_code == '' || addr == '' || detail_addr == ''){
